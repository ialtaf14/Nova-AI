...
| Feature | Preview |
|---|---|
| 🖼️ **Multimodal Vision Q&A** | ![Nova AI Vision Q&A](screenshots/screenshot_1_vision.png) |
| 💬 **Smart Reasoning & Markdown** | ![Nova AI Smart Chat](screenshots/screenshot_2_chat.png) |
| 🚀 **Welcome Screen & Quick Chips** | ![Nova AI Welcome Screen](screenshots/screenshot_3_welcome.png) |
| 🗺️ **Interactive Google Maps Embed** | ![Nova AI Live Maps](screenshots/screenshot_4_maps.png) |
| 🧠 **Multi-Model Selector** | ![Nova AI Model Switcher](screenshots/screenshot_5_models.png) |
| 👨‍💻 **Code Generation & Formatting** | ![Nova AI DeepSeek Coding](screenshots/screenshot_6_coding.png) |
