...
# Must match OllamaBrain.available_models in main.py exactly, otherwise the
# app's default model ("llama3.1") or vision model ("llava") silently fails
# with a "model not found" error the first time someone runs Nova.
# NOTE: "llama3.1" was previously missing from this list even though it's
# main.py's default startup model.
models = [
    "llama3.1",
    "deepseek-coder",
    "mistral",
